...
public class MyLogger {
	...
	public synchronized static void startTest(String testName) {
		...
		if (config.getDefaultProp().getProperty("CICD").equalsIgnoreCase("N")) {
			currentDir = config.getDefaultProp().getProperty("latestReportLocation") + File.separator + "Reports_" + cal1;
			System.out.println("LogFile is : " + currentDir + File.separator + "Logs" + File.separator + testName + "_" + cal3);
			setlogger(currentDir + File.separator + "Logs" + File.separator + testName + "_" + cal3);
		} else {
			currentDir = config.getDefaultProp().getProperty("CICDlatestReportLocation") + File.separator + "Reports_" + cal1;
			System.out.println("LogFile is : " + currentDir + File.separator + "Logs" + File.separator + testName);
			setlogger(currentDir + File.separator + "Logs" + File.separator + testName);
		}
		// if (config.getDefaultProp().getProperty("CICD").equalsIgnoreCase("N")) {
